...
public class Buscaminas {
    ...
    public static void main(String[] args) {
        ...
        modoJuego(getEnteroRango(1, 5));  // significa que se está llamando al método "modoJuego" con el argumento "getEnteroRango(1, 5)". El método "getEnteroRango" devuelve un entero aleatorio entre 1 y 5, por lo que el método "modoJuego" se llamará con un argumento aleatorio entre 1 y 5.
